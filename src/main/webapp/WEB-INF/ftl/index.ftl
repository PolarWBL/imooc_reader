    ...
    <script>
            ...
            $.ajax({
                ...
                success: function (json) {
                    ...
                    for (var i = 0; i < list.length; i++) {
                        ...
                        var html = template("template", book);
                        // console.info(html);
        ...
        $(function () {
            ...
            $(".order").click(function () {
                ...
                $(this).addClass("highlight");
                var order = $(this).data("order");//提取按钮对应的排序方式
                $("#order").val(order);//赋值给#order隐藏域
                loadMore(true);
            })
        })
    </script>
        ...
        <#if loginMember??>
            <h6 class="mt-1">
                <img style="width: 2rem;margin-top: -5px" class="mr-1"
                     src="/images/loginMember.jpg"> ${loginMember.nickname}
            </h6>
        <#else>
    ...
    <div class="row mt-2">
        ...
        <div class="col-8 mt-2">
            ...
            <#list categoryList as category>
                <a style="cursor: pointer" data-category="${category.categoryId}" class="text-black-50 font-weight-bold
